...
export const ABP_API_BASE_URL = new InjectionToken<string>('ABP_API_BASE_URL');
...
export class AccountClient {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(ABP_API_BASE_URL) baseUrl?: string) {
        this.http = http;
...
export class ProductServiceClient {
     ...
     * @return Success
     */
    get(id: number): Observable<ProductSummaryDto> {
        let url_ = this.baseUrl + "/api/services/ProductDemo/ProductService/Get?";
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ProductSummaryDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<ProductSummaryDto>><any>Observable.throw(response_);
        });
    }

    protected processGet(response: HttpResponseBase): Observable<ProductSummaryDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ProductSummaryDto.fromJS(resultData200) : new ProductSummaryDto();
            return Observable.of(result200);
            });
        } else if (status === 401) {
            return blobToText(responseBlob).flatMap(_responseText => {
        ...
        return Observable.of<ProductSummaryDto>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(name: string, sorting: string, skipCount: number, maxResultCount: number): Observable<PagedResultDtoOfProductSummaryDto> {
        let url_ = this.baseUrl + "/api/services/ProductDemo/ProductService/GetAll?";
        if (name !== undefined)
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PagedResultDtoOfProductSummaryDto>><any>Observable.throw(e);
                }
            } else
                return <Observable<PagedResultDtoOfProductSummaryDto>><any>Observable.throw(response_);
        });
    }

    protected processGetAll(response: HttpResponseBase): Observable<PagedResultDtoOfProductSummaryDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfProductSummaryDto.fromJS(resultData200) : new PagedResultDtoOfProductSummaryDto();
            return Observable.of(result200);
            });
        } else if (status === 401) {
            return blobToText(responseBlob).flatMap(_responseText => {
        ...
        return Observable.of<PagedResultDtoOfProductSummaryDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(input: ProductCreateDto): Observable<ProductSummaryDto> {
        let url_ = this.baseUrl + "/api/services/ProductDemo/ProductService/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<ProductSummaryDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(input: ProductCreateDto): Observable<ProductSummaryDto> {
        let url_ = this.baseUrl + "/api/services/ProductDemo/ProductService/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ProductSummaryDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/services/ProductDemo/ProductService/Delete?";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined and cannot be null.");
        else
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
